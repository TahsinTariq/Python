...
def triangulate(pxyz):
    ...
    for p in pxyz:
        ...
        print(f'edges : {edges}')
        # temp = Point(float('inf'), float('inf'))
        # t = Edge(temp, temp)
        # for e1 in edges[:-1]:
        #     for e2 in edges[1:]:
        #         # print(e1,e2)
        ...
        #             try:
        #                 edges[edges.index(e1)] = t
        #                 edges[edges.index(e2)] = t
        #             except:
        #                 pass
...
def main():
    ...
    # c = Point(2,0)
    # t = Triangle(a,b,c)
    # t = Triangle(Point(1.0, 3.0), Point(2.0, 2.0), Point(15.5, -7.5))
    # t2 = Triangle(Point(2.0, 2.0), Point(3.0, 1.0), Point(12.5, -7.5))
    # # print(_angle(a,b,c))
    # p = Point(3,0)
    # val = t.sharesVertex(t2)
    # val = t.circumCircle()
    # print(val)
    # print(points)
